...
enum class ResearchItem(
    ...
    BASIC_RESEARCH(
        ...
        limitEconomyPower = 0,
        imageRes = R.drawable.research_basic,
        displayName = "기초 연구"
    ),
    BEGINNER_RESEARCH(
        cost = 30_000L,
        ...
        imageRes = R.drawable.research_beginner,
        displayName = "초급 연구"
    ),
    INTERMEDIATE_RESEARCH(
        ...
        imageRes = R.drawable.research_itermediate,
        displayName = "중급 연구"
    ),
    UPPER_INTERMEDIATE_RESEARCH(
        ...
        imageRes = R.drawable.research_upper_intermediate,
        displayName = "중고급 연구"
    ),
    ADVANCED_RESEARCH(
        cost = 5_000_000L,
        ...
        imageRes = R.drawable.research_adv,
        displayName = "고급 연구"
    ),
    TOP_LEVEL_RESEARCH(
        cost = 80_000_000L,
        ...
        imageRes = R.drawable.research_top_level,
        displayName = "최고급 연구"
    )
}